...
alter search times~\cite{Redner2001}. The central question of the present work is:
\begin{quote}
\itshape
...
\end{quote}
We derive the relevant Fokker--Planck equation (FPE) from a microscopic lattice random
walk, establish and solve the backward equation for the mean first
passage time (MFPT) on the ring with periodic boundary conditions and a $\delta$-type trap, and carry out a complete
...
The work develops tools from the courses APPM 6470 and APPM 5610 (PDEs, adjoint formulations, boundary conditions, self-adjointness, conservative

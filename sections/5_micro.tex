...
\caption{Microscopic stories for $\kappa(D(0))$ for the tent
profile with $D_0=1$ and $\kappa_0=1$.  %Only the $1/D(0)$ story (red, dash-dotted) exhibits an interior optimum $D_1^*$; the other two are monotone.  The marked point indicates the numerically determined minimum.
}
...
$D_1^*\approx -0.45$ (see \autoref{sec:results}).
